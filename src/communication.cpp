...
// 테스트용 최소 버젼
// void handleRoot() {
//   Serial.println("HTTP 요청 받음");
  
//   // 매우 짧은 HTML
//   String html = "<!DOCTYPE html><html><head><title>Drone</title></head><body>";
//   html += "<h1>Shane Drone Online</h1>";
//   html += "<p>Time: " + String(millis()) + "</p>";
//   html += "<p><a href='/telemetry'>Telemetry Data</a></p>";
//   html += "</body></html>";
...
// // 테스트용 최소 버젼
// void handleTelemetryData() {
//   Serial.println("텔레메트리 요청 받음");
  
//   // 작은 JSON 문서 사용
//   DynamicJsonDocument doc(256);  // 1024에서 256으로 줄임
  
//   doc["r"] = sensorData.roll;     // 키 이름 단축
//   doc["p"] = sensorData.pitch;
//   doc["y"] = sensorData.yaw;
//   doc["b"] = batteryVoltage;
//   doc["a"] = systemArmed;
//   doc["t"] = millis();
